                  ...
                  <form class="space-y-8" @submit.prevent="handleUpdateStream">
                    <div>
                      ...
                      <input
                        v-model="form.title"
                        type="text"
                        class="neon-glow w-full rounded-lg border-none bg-surface-container-low p-4 font-medium text-on-surface outline-none ring-1 ring-white/5 transition-all focus:bg-surface-container-high focus:ring-primary/50"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows="6"
                        class="neon-glow w-full rounded-lg border-none bg-surface-container-low p-4 font-medium leading-relaxed text-on-surface outline-none ring-1 ring-white/5 transition-all focus:bg-surface-container-high focus:ring-primary/50"
              ...
              <div class="space-y-8 lg:col-span-4">
                ...
                <div class="space-y-4">
                  <button
                    ...
                    class="group flex w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-primary to-secondary py-4 font-bold tracking-tight text-on-primary-fixed transition-all hover:shadow-[0_0_30px_rgba(246,128,255,0.4)] disabled:cursor-not-allowed disabled:opacity-60"
...
.neon-glow:focus {
  box-shadow: 0 0 20px rgba(246, 128, 255, 0.2);
}
</style>